          ...
          <div className="footer-icon">
            <div className="col-lg-4 col-md-12 d-flex align-items-center ">
              <p className="mx-auto text-center mb-0">
                Copyright &copy; 2023 All rights reserved | This is a property
                of{' '}
                <a
                  href="https://nhubinternship.onrender.com/"
                  target="_blank"
            ...
            <div className="col-lg-4 col-md-12">
              <nav className="nav nav-mastfoot justify-content-center">
                <a
                  className="nav-link"
                  href="https://web.facebook.com/nHubNigeria"
                  target="_blank"
                  rel="noreferrer"
                >
                ...
                <a
                  className="nav-link"
                  href="https://www.linkedin.com/company/nhub/"
                  target="_blank"
                  rel="noreferrer"
                >
